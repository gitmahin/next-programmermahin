                              ...
                              <div key={`${i}-${j}`}>
                                ...
                                >
                                  <li
                                    ...
                                    className={`flex justify-between items-center text-read_2 font-medium pl-3 rounded-tiny py-0 ${isActivePathDir ? "bg-background-color_800C font-semibold relative text-text-color_1" : `${path_name.split("/").includes(childValue.slug) ? "text-text-color_1 font-semibold" : "text-text-color_4 group-hover:text-text-color_1"}`}`}
                                  >
                                ...
                                >
                                  {childValue.items.map((subItem, k) => {
                                    ...
                                    return (
                                      ...
                                      >
                                        <li
                                          className={`px-3 py-0 relative one_line_ellipsis rounded-tiny text-read_2  ${isActivePathSubItem ? "text-text-color_1 font-semibold bg-background-color_800C" : "font-medium text-text-color_4 group-hover:text-text-color_1"}`}
                                        >
