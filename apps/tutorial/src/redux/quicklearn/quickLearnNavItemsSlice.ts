...
export const quickLearnNavItemsSlice: Slice<QuickLearnNavItemDataType> =
  createSlice({
    ...
    reducers: {
      setQuickLearnNavitems: (
        state,
        action: PayloadAction<GeneralNavItemType[]>
      ) => {
...
export const quickLearnNavItems = (state: RootState) =>
  state.quickLearnNavItems.data;
