...
import { TriangleAlert, CircleX , RefreshCw, Braces, BellDot} from "lucide-react"

export const VsFooter = () => {
    return <div className="w-full h-[16px] border-t border-[var(--github-default-border-color-1)] bg-[var(--github-default-background-color-2)] flex justify-between items-center px-2 font-light">
