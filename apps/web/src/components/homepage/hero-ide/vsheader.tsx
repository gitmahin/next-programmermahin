...
export const VsHeader = () => {
    return <div className="w-full h-[25px] bg-[var(--github-default-background-color-2)] border-b border-[var(--github-default-border-color-1)] flex justify-between items-center">
